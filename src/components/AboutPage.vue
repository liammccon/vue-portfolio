<template>
    ...
    <div class="container-fluid ps-lg-3 pe-lg-3 ps-sm-2">
        <div class="row">
            <div class="col-lg-8 text-start">
                <h1 class="text-center">Hi, I'm Liam!</h1> 
                <h3>I am a musician and programmer, finishing my undergrad with a major in music and a minor in computer science.</h3>
